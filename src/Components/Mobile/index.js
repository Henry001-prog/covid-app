...
import { CardMobile } from '../../Components/CardMobile/styles';
        ...
        <Div>
            ...
            { loading ?
                ...
                <Container>
                    ...
                    <CardMobile style={{backgroundColor: '#e38826'}}>
                        <DivRow>
                            <SubText title='País:' />
                        ...
                        <DivRow>
                            ...
                            <TextSecond title={data[23].TotalRecovered} />
                        </DivRow>
                    </CardMobile>

                    <CardMobile style={{backgroundColor: '#006970'}}>
                        <DivRow>
                            <SubText title='País:' />
                        ...
                        <DivRow>
                            <SubText title='Total de Recuperados:' />
                            <TextSecond title={data[30].TotalRecovered} />
                        </DivRow>
                    </CardMobile>

                    <CardMobile style={{backgroundColor: '#576719'}}>
                        <DivRow>
                            <SubText title='País:' />
                        ...
                        <DivRow>
                            <SubText title='Total de Recuperados:' />
                            <TextSecond title={data[35].TotalRecovered} />
                        </DivRow>
                    </CardMobile>

                    <CardMobile style={{backgroundColor: '#484d32'}}>
                        <DivRow>
                            <SubText title='País:' />
                        ...
                        <DivRow>
                            <SubText title='Total de Recuperados:' />
                            <TextSecond title={data[59].TotalRecovered} />
                        </DivRow>
                    </CardMobile>

                    <CardMobile style={{backgroundColor: '#3b4d32'}}>
                        <DivRow>
                            <SubText title='País:' />
                        ...
                        <DivRow>
                            <SubText title='Total de Recuperados:' />
                            <TextSecond title={data[63].TotalRecovered} />
                        </DivRow>
                    </CardMobile>

                    <CardMobile style={{backgroundColor: '#50472f'}}>
                        <DivRow>
                            <SubText title='País:' />
                        ...
                        <DivRow>
                            <SubText title='Novos Recuperados:' />
                            <TextSecond title={data[76].NewRecovered} />
                        </DivRow>
                        <DivRow>
                            <SubText title='Total de Recuperados:' />
                            <TextSecond title={data[76].TotalRecovered} />
                        </DivRow>
                    </CardMobile>

                    <CardMobile style={{backgroundColor: '#422f50'}}>
                        <DivRow>
                            <SubText title='País:' />
                        ...
                        <DivRow>
                            <SubText title='Total de Recuperados:' />
                            <TextSecond title={data[180].TotalRecovered} />
                        </DivRow>
                    </CardMobile>

                    <CardMobile style={{backgroundColor: '#658d9a'}}>
                        <DivRow>
                            <SubText title='País:' />
